...
const ProfileView = ({ onSettingsClick, isPartnership, setIsPartnership, profileColor, setProfileColor }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 dark:bg-[#05070A] overflow-y-auto pb-32 relative [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      {/* Soft gradient glow for Partnership profile */}
      <div
      ...
      <div className="flex flex-col px-4 pt-6 pb-4 gap-6 relative z-10">
        <div className="flex flex-col gap-6">
          <div className="flex justify-between items-start">
            <div className="flex flex-col flex-1 pr-4">
              <div className="flex items-center gap-2">
                ...
                {isPartnership && (
                  <span
                    className="px-2 py-0.5 rounded-md text-[10px] font-bold text-white uppercase tracking-wider shadow-sm transition-colors duration-500"
              ...
              <p
                className="text-[14px] font-bold mt-1 mb-2 transition-colors duration-500"
                style={{ color: isPartnership ? profileColor : '#6C5CE7' }}
              >
                @{MOCK_USER.username}
              </p>
            ...
            {/* Colorful custom ring for Partnership */}
            <div
              className="relative w-[84px] h-[84px] rounded-full p-[3px] flex-shrink-0 shadow-lg transition-all duration-500"
              style={{
                background: isPartnership ? `linear-gradient(to bottom right, ${profileColor}, ${profileColor}30)` : 'linear-gradient(to top right, #6C5CE7, #00D1FF)'
              }}
            >
          ...
          {/* Premium Circular Personas / Highlights */}
        ...
        {/* Partnership Settings Toggle Block */}
        <div className="flex flex-col gap-4 p-4 rounded-2xl bg-white dark:bg-[#111827] border border-black/5 dark:border-white/[0.08] shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-[14px] font-bold text-gray-900 dark:text-white flex items-center gap-2">
              <span className="text-xl">✨</span> Partnership Account
            </span>
            <div
              ...
              <div className="flex gap-3">
                {PRESET_COLORS.map(color => (
                  <button
                    ...
                    className={`relative w-6 h-6 rounded-full shadow-sm transition-all duration-300 ${profileColor === color ? 'scale-125' : 'hover:scale-110'}`}
                    style={{ backgroundColor: color }}
                  >
                    {profileColor === color && (
                      <span className="absolute inset-0 rounded-full border-2 border-white dark:border-[#111827] shadow-[0_0_0_2px_currentColor]" style={{ color }} />
                    )}
                  </button>
                ))}
              </div>
      ...
      <div className="flex flex-col items-center justify-center pt-10 text-gray-500 relative z-10">
